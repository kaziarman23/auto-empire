...
export async function POST(request) {
  ...
  const post_data = {
    ...
    currency: "BDT",
    tran_id,
    success_url: `${process.env.NEXT_PUBLIC_BASEURL}/api/ssl-payment/success`,
    fail_url: `${process.env.NEXT_PUBLIC_BASEURL}/api/ssl-payment/fail`,
    cancel_url: `${process.env.NEXT_PUBLIC_BASEURL}/api/ssl-payment/cancel`,
    ipn_url: `${process.env.NEXT_PUBLIC_BASEURL}/api/ssl-payment/ipn`,
    shipping_method: "NO",
